...
class WC_Account_Funds_Query {
	 ...
	 *
	 * @return WC_Account_Funds_Query this for chaining.
	 * @global object $wpdb
	 *
	 * @since 1.0.0
	 *
	 ...
	 *
	 * @return WC_Account_Funds_Query The current query builder.
	 */
	public function where( $column, $param1 = null, $param2 = null, $joint = 'and' ) {
		...
		if ( is_array( $column ) ) {
			...
			$subquery = new WC_Account_Funds_Query();
	 ...
	 *
	 * ->find('mahedihasannoman@gmail.com', 'email')
	 *
	 * @param int $id
	 * @param string $key
	 *
